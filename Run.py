...
nu, sigma = read_cross_section_file(species = species, database = database,
                                    filename = 'Na_I_T1000K_log_P0.0_H2-He_sigma.txt')
...
plot_cross_section(collection = cross_sections, labels = ['Na', 'K', 'Ca', 'Ca+'], filename = 'Atomic_cross_sections_for_joss_figure', linewidth = 1.3, smooth_data = True, x_max=2)
