...
plot_cross_section(collection = cross_sections, labels = ['12C-16O', '13C-16O'], filename = 'Isotopologue_cross_sections_for_joss_figure', linewidth = 1.5, smooth_data = True)
